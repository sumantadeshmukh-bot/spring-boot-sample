...
- Controllers call repositories directly — there is no service layer. Don't introduce one unless the task specifically requires business logic that doesn't belong in a controller or repository.
